...
rfalllist=basepath.format("data/gramTri/other/allpatterns.xlsx")
rfcvclist=basepath.format("data/gramTri/other/cvcpatterns.xlsx")
rfvcvlist=basepath.format("data/gramTri/other/vcvpatterns.xlsx")

allDf = pd.read_excel(rfalllist, sheet_name=0, header=0, index_col=0)
cvcDf = pd.read_excel(rfcvclist, sheet_name=0, header=0, index_col=0)
vcvDf = pd.read_excel(rfvcvlist, sheet_name=0, header=0, index_col=0)
